...
void GTIA_StateSave_Ctx(Atari800_Instance *inst)
{
	...
	STATESAV_TAG(gtia);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_HPOSP0, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_HPOSP1, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_HPOSP2, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_HPOSP3, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_HPOSM0, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_HPOSM1, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_HPOSM2, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_HPOSM3, 1);
	StateSav_SaveUBYTE_Ctx(inst, &PF0PM, 1);
	StateSav_SaveUBYTE_Ctx(inst, &PF1PM, 1);
	StateSav_SaveUBYTE_Ctx(inst, &PF2PM, 1);
	StateSav_SaveUBYTE_Ctx(inst, &PF3PM, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_M0PL, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_M1PL, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_M2PL, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_M3PL, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_P0PL, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_P1PL, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_P2PL, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_P3PL, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_SIZEP0, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_SIZEP1, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_SIZEP2, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_SIZEP3, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_SIZEM, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_GRAFP0, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_GRAFP1, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_GRAFP2, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_GRAFP3, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_GRAFM, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_COLPM0, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_COLPM1, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_COLPM2, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_COLPM3, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_COLPF0, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_COLPF1, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_COLPF2, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_COLPF3, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_COLBK, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_PRIOR, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_VDELAY, 1);
	StateSav_SaveUBYTE_Ctx(inst, &GTIA_GRACTL, 1);

	StateSav_SaveUBYTE_Ctx(inst, &consol_mask, 1);
	StateSav_SaveINT_Ctx(inst, &GTIA_speaker, 1);
	StateSav_SaveINT_Ctx(inst, &next_console_value, 1);
	StateSav_SaveUBYTE_Ctx(inst, GTIA_TRIG_latch, 4);
}
...
void GTIA_StateRead_Ctx(Atari800_Instance *inst, UBYTE version)
{
	...
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_HPOSP0, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_HPOSP1, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_HPOSP2, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_HPOSP3, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_HPOSM0, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_HPOSM1, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_HPOSM2, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_HPOSM3, 1);
	StateSav_ReadUBYTE_Ctx(inst, &PF0PM, 1);
	StateSav_ReadUBYTE_Ctx(inst, &PF1PM, 1);
	StateSav_ReadUBYTE_Ctx(inst, &PF2PM, 1);
	StateSav_ReadUBYTE_Ctx(inst, &PF3PM, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_M0PL, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_M1PL, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_M2PL, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_M3PL, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_P0PL, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_P1PL, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_P2PL, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_P3PL, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_SIZEP0, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_SIZEP1, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_SIZEP2, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_SIZEP3, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_SIZEM, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_GRAFP0, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_GRAFP1, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_GRAFP2, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_GRAFP3, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_GRAFM, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_COLPM0, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_COLPM1, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_COLPM2, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_COLPM3, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_COLPF0, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_COLPF1, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_COLPF2, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_COLPF3, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_COLBK, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_PRIOR, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_VDELAY, 1);
	StateSav_ReadUBYTE_Ctx(inst, &GTIA_GRACTL, 1);

	StateSav_ReadUBYTE_Ctx(inst, &consol_mask, 1);
	StateSav_ReadINT_Ctx(inst, &GTIA_speaker, 1);
	StateSav_ReadINT_Ctx(inst, &next_console_value, 1);
	if (version >= 7)
		StateSav_ReadUBYTE_Ctx(inst, GTIA_TRIG_latch, 4);
